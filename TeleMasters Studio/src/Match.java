...
public class Match {
	// Edit fileDirectory
	static String fileDirectory = ExcelHandler.fileDirectory();
	...
	public static void writeResultsToExcel(LeaderEntry maxKills, LeaderEntry maxDefuses, LeaderEntry maxPlants, LeaderEntry maxSupport, LeaderEntry matchMVP, String gameName) {
	    try {
	        ...
	        FileOutputStream outputStream = new FileOutputStream(fileDirectory + "LeagueLeaders_" + gameName + ".xlsx");
	...
	private void matchSched() throws Exception {
		...
		lblBanner.setIcon(new ImageIcon(fileDirectory + "MATCH SCHED.png"));
	...
	private void playMatch() throws Exception {
		...
		lblLogo.setIcon(new ImageIcon(fileDirectory + "PLAY MATCH.png"));
